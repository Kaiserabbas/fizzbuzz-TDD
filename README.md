...
# 📖 [TDD Fizzbuzz] <a name="about-project"></a>

**TDD Fizzbuzz** is a Ruby project that will allow you to:

- Add solution for the challange and tests.
...
In order to use this project.. Clone this repository to your desired folder by pasting this command in your command line interface:
  ...
  https://github.com/Kaiserabbas/fizzbuzz-with-test.git
...
- GitHub: [@Enock](https://github.com/Bettenoch/) 
